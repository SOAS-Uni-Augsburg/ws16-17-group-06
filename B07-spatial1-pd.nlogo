patches-own [
  ...
  ready_to_play ;; patch hat die runde noch nicht gespielt
  last_payoffs ;; speichert gewonnene punkte der letzten 8 runden
  last_payoffs_iterator ;; gibt an welches die älteste runde ist
]
...
to setup
  ...
  ask patches [
    ...
    set last_payoffs_iterator 0
    set last_payoffs [0 0 0 0 0 0 0 0]
    update-color
  ]
...
to interact  ;; patch procedure
  ;; zufällig ausgewählter gegner aus moore nachbarschaft
  ;; jeder Spieler spielt nur 1x pro runde
  if ready_to_play = "yes" [
    set ready_to_play "no"
    let payoff1 0
    ...
    ask neighbors [
      if ready_to_play = "yes"[
        ...
        let action1 "a"
         ...
         if strategy1 = "grim trigger" [
           set action1 "d"
         ]
         if strategy1 = "tranquilizer" [
           set action1 "c"
         ]
         ...
         if action1 = "c" and action2 = "c" [
           set payoff1 payoff-r
           ]
         if action1 = "c" and action2 = "d" [
           set payoff1 payoff-s
           ]
         if action1 = "d" and action2 = "c" [
           set payoff1 payoff-t
           ]
         if action1 = "d" and action2 = "d" [
           set payoff1 payoff-p
           ]
         set last_payoffs replace-item last_payoffs_iterator last_payoffs payoff1
         ifelse last_payoffs_iterator < 7 [
           set last_payoffs_iterator last_payoffs_iterator + 1
           ]
         [
           set last_payoffs_iterator 0
           ]
...
let payoff1 "null"
let strategy1 "random"
ask neighbors [
let payoff2 0
foreach last_payoffs [
  set payoff2 payoff2 + ?
  ]
if payoff1 = "null" or payoff1 < payoff2 [
  set payoff1 payoff2
  set strategy1 strategy
  ]
]
